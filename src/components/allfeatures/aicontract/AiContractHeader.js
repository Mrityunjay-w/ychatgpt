...
const AiContractHeader = () => {
    ...
    const handleAdvanceFeaturesClick = () => {
     ...
     const { theme, toggleTheme } = useContext(AiContractThemeContext);
        ...
        <div className='text-2xl '>
            ...
            <div>
                ...
                <p className="text-3xl font-semibold" style={{ position: 'absolute', top: '21px', right: '638px' }}>
                    <span className="text-white">AI Contract Manager</span>
                </p>
            </div>
...
export default AiContractHeader;