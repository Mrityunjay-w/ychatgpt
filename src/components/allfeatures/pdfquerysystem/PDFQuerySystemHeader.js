...
const PDFQuerySystemHeader = () => {
    ...
    const { theme, toggleTheme } = useContext(PDFQuerySystemThemeContext);
            ...
            <div className='text-2xl '>
                ...
                <div>
                    ...
                    <p className="text-3xl font-semibold" style={{ position: 'fixed', top: '21px', right: '638px' }}>
                        <span className="text-white ">PDF Query System</span>
                    </p>
                </div>
...
export default PDFQuerySystemHeader;