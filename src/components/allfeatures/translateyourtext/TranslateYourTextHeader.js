...
const TranslateYourTextHeader = () => {
    ...
    const { theme, toggleTheme } = useContext(TranslateYourTextThemeContext);
        ...
        <div className=''>
            <div className='text-2xl '>
                ...
                <div>
                    ...
                    <p className="text-3xl font-semibold  " style={{ position: 'absolute', top: '21px', right: '769px' }}>
                        <span className="text-white ">Translate Your Text</span>
                    </p>
...
export default TranslateYourTextHeader;