...
const YchatGPTSupportBot = () => {
    ...
    const InitializeWebChat = useCallback(async () => {
        ...
        const tokenEndpointURL = new URL('https://default0da2a83b13d94a35965fec53a220ed.9d.environment.api.powerplatform.com/powervirtualagents/botsbyschema/cr09e_yChatGptSupport/directline/token?api-version=2022-03-01-preview');
        ...
        <>
            {isChatbotActive && (
                <div className={`chatbot-popup ${isMinimized ? 'minimized' : ''}`}>
                    <div id="banner">
                        <h1 className="banner-title">Y-ChatGPT-Support</h1>
...
export default YchatGPTSupportBot;